...
description: 'Multi-tenant SaaS for worship bands and churches. Leader controls the service from a tablet, projector shows the lyrics animated, every musician sees the chords in sync. All under 100 ms via a 1,023-line WebSocket gateway load-tested to 500 concurrent users.'
type: 'saas'
status: 'live'
order: 2
featured: true
...
esTagline: 'Gestión de alabanza en tiempo real para bandas e iglesias'
esDescription: 'SaaS multi-tenant para bandas e iglesias. El líder controla el servicio desde una tablet, el proyector muestra las letras animadas, cada músico ve los acordes en sync. Todo bajo 100 ms vía un WebSocket gateway de 1,023 líneas load-tested a 500 usuarios concurrentes.'
esHighlights:
