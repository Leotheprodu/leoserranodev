...
highlights:
  - 'Sitio público + portal de artistas + e-commerce de beats en un solo monorepo'
...
The system has three cooperating apps in a single monorepo:

- **`server/`** — NestJS 10 API, Prisma 5, Socket.IO, JWT, 30 modules
- **`app-new/`** — Next.js 15 public site + studio management (admin, portal, blog)
- **`ackeeBeats/`** — Next.js 15 e-commerce for selling beats with PayPal

Together they ship **~74,000 lines of code** across 865 files. Every single
